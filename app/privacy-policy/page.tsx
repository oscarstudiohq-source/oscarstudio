    ...
    return (
        <div>
            ...
            <div className="max-w-3xl mx-auto p-6">
                ...
                <p className="mb-4">
                    This Privacy Policy explains how OscarStudio (operated by Bigmeet Infotech Private Limited) collects, uses, and protects personal information when you use our platform.
                </p>
