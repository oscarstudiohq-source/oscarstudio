    ...
    return (
        <div>
            ...
            <div className="max-w-3xl mx-auto p-6">
                ...
                <p className="mb-6">
                    For any questions regarding orders, payments, or services provided through <strong>TuesdayTrim.com</strong>,
                ...
                <p className="mb-4">
                    <a href="https://tuesdaytrim.com" className="text-blue-600 underline" target="_blank" rel="noopener noreferrer">
                        www.tuesdaytrim.com
                    </a>
                </p>
                ...
                <p className="mb-4">
                    <a href="mailto:support@tuesdaytrim.com" className="text-blue-600 underline">
